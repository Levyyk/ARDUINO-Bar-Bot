...
## 📸 Етапи створення та збірки (Gallery)

Ось як проєкт народжувався «наживо» — від креслень і підготовки корпусу до пайки та монтажу електроніки:

| Проєктування та креслення | Обтягування корпусу | Внутрішня комутація і пайка |
| :---: | :---: | :---: |
| ![Blueprint](photos/blueprint.jpg) | ![Wrapping](photos/wrapping.jpg) | ![Electronics](photos/electronics.jpg) |
...
* **Захист від "одиноких барменів" 🍻:** Якщо поставити лише 1 склянку і спробувати запустити налив, бот виведе на екран жартівливе попередження та відмовитися наливати (але режим промивки для однієї склянки працює штатно).
